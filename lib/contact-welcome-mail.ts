...
/** 언어별 CTA 버튼 텍스트 */
function welcomeCtaText(language: ContactMessageLanguage): string {
  switch (language) {
    case "Korean":
      return "hapvi.org 방문하기";
    case "Spanish":
      return "Visitar hapvi.org";
    case "English":
    case "Other":
    default:
      return "Visit hapvi.org";
  }
}
...
function buildWelcomeHtml(language: ContactMessageLanguage, name: string): string {
  ...
  const ctaText = welcomeCtaText(language);
  const footerLinkStyle = `color:${BURGUNDY};text-decoration:underline;`;

  return `<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8" /><meta name="viewport" content="width=device-width,initial-scale=1" /></head>
<body style="margin:0;padding:0;background-color:#F5F2F2;font-family:Arial,Helvetica,sans-serif;">
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color:#F5F2F2;">
<tr>
<td align="center" style="padding:24px 16px;">
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;border-radius:8px;overflow:hidden;">

<tr>
<td style="background-color:${BURGUNDY};padding:28px 28px 24px;text-align:center;">
<p style="margin:0;font-size:24px;font-weight:700;color:#ffffff;letter-spacing:-0.02em;">HapVi Together</p>
</td>
</tr>
...
<tr>
<td style="background-color:#ffffff;padding:0 28px 28px;text-align:center;">
<a href="${SITE}"
   style="display:inline-block;background-color:${BURGUNDY};color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;padding:13px 36px;border-radius:4px;letter-spacing:0.01em;">${ctaText}</a>
</td>
</tr>

<tr>
<td style="background-color:#FAF5F5;padding:18px 28px;border-top:1px solid #EAE0E0;">
<p style="margin:0;font-size:13px;line-height:1.7;color:#777777;">
<a href="mailto:info@hapvi.org" style="${footerLinkStyle}">info@hapvi.org</a>
&nbsp;·&nbsp;
<a href="${SITE}" style="${footerLinkStyle}">hapvi.org</a>
&nbsp;·&nbsp;
<a href="${PRIVACY_URL}" style="${footerLinkStyle}">Privacy Policy</a>
</p>
<p style="margin:6px 0 0;font-size:12px;color:#999999;">EIN: 33-3980325</p>
</td>
</tr>
